package co.franquicia.r2dbc;

import co.franquicia.r2dbc.adapter.FranquiciasAdapter;
...
class MyReactiveRepositoryAdapterTest {
    ...
    @InjectMocks
    FranquiciasAdapter repositoryAdapter;

    @Mock
    ReactiveFranquiciaRepository repository;
